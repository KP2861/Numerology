...
@section('content')
    <h1 class="mb-4">Advance Numerology List</h1>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $("#myTable").DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('advance_numerology.list') }}",
                responsive: true,
                lengthChange: true,
                autoWidth: false,
                paging: true,
        ...
        function confirmDelete(id) {
            if (confirm('Are you sure you want to delete this entry?')) {
                var url = '{{ route('admin.advance_numerology.destroy', ':id') }}';
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.expired-download-btn', function() {
                ...
                $('#downloadForm').attr('action',
                    "{{ route('numerology.advance_numerology_auto-download') }}");
