...
<div class="hs_indx_title_main_wrapper py-0">
    ...
    <div class="hs_kd_sidebar_main_wrapper hs_num_sidebar_main_wrapper numero-tabs-sec">
        <div class="container">
            <div class="row py-xxl-5 gy-5 m-0">
                <div class="col-12">
                    <ul class="tabs">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="hs_about_heading_main_wrapper text-start">
                    <div class="">
                        <h2 class="subheading mb-3 fw-bold">What is <span>Name Numeroscope?</span></h2>
                        <!-- <h4><span></span></h4> -->
                        <p class="para">Numerology entails the study of the mystical relationship that exists between numbers and life incidents. Numerology is the art through which you get a name or number that offers more insight into your traits, relationship, employment, et cetera. This is a very interesting journey along self discovery which may help you discover more about yourself and the world beyond. Therefore, regardless of whether you are interested in the mysterious world of numerology or need advice on your lifetime options, our Name Numerology Calculator can assist you. Get to know your name; unravel its secret, and open a new pathway toward life’s clarity and fulfillment.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-5 pt-5">
            <div class="col-7">
                ...
                <p class="para mt-3">
                    This is the actual numerical value of your name. It is calculated using the letters of your first and last name and describes your overall character. It can also reveal potential strengths and weaknesses instilled in you at birth. Personality number.
                </p>
            </div>
            <div class="col-5">
                <img id="name" src="{{url('frontend/assests/images/content/numerology/mobile-numerology-section.png')}}" class="img-fluid">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
            ...
            <div class="col-12">
                <div class="hs_about_heading_main_wrapper text-start">
                    <div class="">
                        ...
                        <p class="para">The mobile you use has significance because of your mobile number. Every feature of your smartphone works on your mobile number. People can contact you only because of your mobile number. Hence, the worthiness of your phone number cannot be undermined. Mobile phone numerology report assists you in choosing a mobile number compatible with your birth number (psychic number) or mot. Mobile numerology calculation adds up all the digits of the mobile number, reduces it to a single number, and then checks the compatibility of the single number obtained with the psychic number. A compatible mobile number, as per numerology, is a lucky mobile number. A lucky number vibrates with positive frequency and attracts goodness.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-5 pt-5">
            <div class="col-7">
                ...
                <p class="para mt-3">
                    A mobile phone is no longer a luxury; it is a necessity. In the present scenario, a smartphone is everything. From connecting with dear ones to tracking the whereabouts of your close ones to meeting expenses at a click to monitoring health, there is nothing you can’t do with a mobile phone.
                </p>
                <p class="para mt-2">
                    You have invested a sum of money on your new phone, but did you think about your mobile number? What if your mobile number is not lucky for you and becomes the cause of concern? You may think what a lucky mobile number is.
                </p>
                <p class="para mt-2">
                    Numerology can help you find a lucky mobile phone number. Mobile numerology suggests a mobile number compatible with your date of birth. Selecting favourable numbers as per mobile numerology can enhance the positive vibrations of your number and its ruling planet, attracting goodness into your life.
                </p>
    ...
    <div class="container">
                ...
                <div class="hs_about_heading_main_wrapper text-start">
                    <div class="">
                        ...
                        <p class="para">Advanced Numerology is the study of the
                            ...
                            Vedic Astrology
                            . It reveals the occultsecrets that are inherent in the numbers. In this present world of stress and strife where unhappiness and a lack ofmental peace have become the order of the day, it helps us identify our strengths and weaknesses and makes ourlives harmonious and happier by avoiding the weak fields and harnessing the strengths inherent in us. To put itsimply, advanced numerology is an
                            occult technology
        ...
        <div class="row mt-5 pt-5">
            ...
            <h2 class="subheading fw-bold">
                ...
                <p class="para mt-3">
                    One may think that the numbers are used in mathematical calculations only and they do not reflect anything beyondthat. But the popular notion of mankind since time immemorial is that the numbers have an occult and secretivereflection attained from planets and that they always act at the behest of planets. This notion gradually gainedcredence as the science of numerology proved its worth time and again.
                </p>
                <p class="para mt-2">
                    Advanced numerology helps us to identify the possible good and bad periods in our lives so that we can choose to becareful and cautious. It also works as an effective instrument in predicting the various events in our lives. Advancednumerology has a clear-cut method for discerning such events.
                </p>
            ...
            <div class="col-12">
                <div class="hs_about_heading_main_wrapper text-start">
                    <div class="">
                        ...
                        <p class="para">Business numerology revolves around comparing one’s good or bad numbers to the names of their companies, brands or businesses. Choosing a suitable company name as per numerology calculations may bring people luck. One must also consider other suitable variables when determining the business numerology. This includes figuring out the ideal time to establish a firm, the optimal period to close deals, vetting potential business partners and much more.</p>
                    </div>
                </div>
            </div>
        </div>
