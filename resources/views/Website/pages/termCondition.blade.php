...
<section class="term-condition">
    <div class="container">
        <h1 class="term-main-heading mb-5">
            TERMS OF SERVICE
        </h1>
        <h3 class="term-subtitle mb-3">
            OVERVIEW
        </h3>
        <p class="term-para mb-2">
            This website is operated by RAVI MUNDRRA NUMEROLOGY. Throughout the site, the terms “we”, “us” and “our” refer
            to RAVI MUNDRRA NUMEROLOGY. RAVI MUNDRRA NUMEROLOGY offers this website, including all information, tools and
        ...
        <h3 class="term-subtitle mt-3 mb-3">
            ONLINE STORE TERMS
        </h3>
        <p class="term-para mb-2">
        ...
        <p class="term-para mb-2">
            In no case shall RAVI MUNDRRA NUMEROLOGY, our directors, officers, employees, affiliates, agents, contractors,
        ...
        <p class="term-para mb-2">
            You agree to indemnify, defend and hold harmless RAVI MUNDRRA NUMEROLOGY and our parent, subsidiaries,
        ...
        <p class="term-para mb-4">
        Questions about the Terms of Service should be sent to us at Support@swrahan.com.
        </p>
