...
@section('content')
    ...
    <section class="consultant-form-sec bg-white py-5">
        <div class="container ">
            <div class="py-xxl-5">
                <div class="row justify-content-center">
                    <div class=" col-8 col-xxl-10">
                        <div class="text-center">
                            ...
                            <p class="para">
                                Note : Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi, nobis dolores.
                                Voluptatibus explicabo exercitationem laudantium blanditiis voluptates molestias vel maxime
                                temporibus dicta!Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi, nobis
                                dolores.
                            </p>
                        </div>
