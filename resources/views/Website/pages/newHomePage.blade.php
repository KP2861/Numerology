...
<head>
    <meta charset="utf-8" />
    <title>Ravi Mundrra Numerology</title>
...
<body>
    ...
    <div class="redesign-navigation-header-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="hs_main_menu_n hidden-xs d-flex justify-content-between flex-row align-items-center">
                        <div class="header-logo d-flex gap-1">
                            <img src="{{ asset('frontend/assests/images/hero-section/logo-symbol.svg') }}"
                                alt="img">
                            <img src="{{ asset('frontend/assests/images/hero-section/name-logo.svg') }}"
                                alt="">
                        </div>
                        <div class="d-flex align-items-baseline h-100">
                            ...
                            <div class="d-flex align-items-center justify-content-center ms-3"><button
                                    class="outline-button">Get your Report Now</button></div>
    ...
    <section class="intro-hero-section custom-hero-padding moon-bg-absolute">
        <div class="container">
            <div class="row">
                <div class="reach-us-section pt-3 pb-xxl-5 mb-5 gap-3 pb-lg-4">
                    <div>
            ...
            <div class="row mb-5 align-items-start gy-md-0 gy-5 ">
                <div class="col-xl-6 col-lg-7 order-md-1 order-2">
                    ...
                    <p class="gen-para mb-xxl-5 mb-4">
                        ...
                        home,
                        clarity in your career, or alignment with your personal destiny, we offer customized solutions
                        to
                ...
                <div class="col-xl-6 col-lg-5 order-md-2 order-1">
                    <div class=" h-100 mt-xxl-5 mt-2 py-lg-0 py-md-5 py-0">
                        <div class="pattern-outer h-100" id="heroanimate">
                            <img src="{{ asset('frontend/assests/images/hero-section/random-pattern.png') }}"
                                alt="" class="img-fluid web">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-12">
                    <div class="video-player pb-3 mt-5">
                        <iframe height="400" src="https://www.youtube.com/embed/D5WbLG82-gw"
                        ...
                        <div class="carousel-item">
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-8 custom-carousel-content">
                                    ...
                                    <p class="mb-3 carousel-content-descriprtion">It has survived not only five
                                ...
                                <div class="hs_footer_qr_wrapper text-end">
                                    <div class="qr-wrapper p-3 text-center mx-auto rounded">
                                        <img src="{{ asset('frontend/assests/images/content/whatsaap-qr-img.png') }}"
                                            alt="footer_logo" class="img-responsive"
                                            class="img-fluid rounded-pills" />
