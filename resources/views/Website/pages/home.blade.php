            ...
            <div class="row">
                <div class="reach-us-section pt-3 pb-xxl-2 mb-5 gap-3 pb-lg-2">
                    <div>
                        <div class="contact-us-sub-section  gap-3">
                            ...
                            <div class="reach-us subtitle ms-md-4">
                                <div class="d-flex align-items-center justify-content-center h-100"><img
                                        src="{{ asset('frontend/assests/images/hero-section/call-icon.svg') }}"
                                        alt="icon">
                                </div>
                                <div class="subtitle-inner ms-2">
                    ...
                    <div class="d-flex justify-content-between   gap-4">
                        ...
                        <div class="button-outer"><a href="{{ url('/login') }}"><button
                                    class="fill-button fill-button-hero"><img
            ...
            <div class="content-brown-cards ">
                <div id="astrology" class="content-section">
                    <div class="row">
                        ...
                        <div class=" d-flex justify-content-center text-center flex-column mb-5">
                            ...
                            <div><img src="{{ asset('frontend/assests/images/hero-section/gold-adorn.svg') }}"
                                    alt="icon">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="brown-cards-content mt-5 mb-lg-5 mb-3">
                                <p class="mb-2">Discover the transformative power of astrology with Swrahan! We don’t
                                    just
                    ...
                    <div class="row">
                        ...
                        <div class=" d-flex justify-content-center text-center flex-column mb-5">
                            ...
                            <div class="mb-lg-0 mb-5"><img
                                    src="{{ asset('frontend/assests/images/hero-section/gold-adorn.svg') }}"
                                    alt="icon">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5">
                            <div class="image-wrapper h-100">
                                <div class="animation-wrapper" id="globeanimate">
                                    <img src="{{ asset('frontend/assests/images/hero-section/globe-hands.png') }}"
                                        alt="" class="img-fluid web-2">
                                </div>
                        ...
                        <div class="col-lg-7">
                            <div class="brown-cards-content mt-5 mb-lg-5 mb-3">
                                <p class="mb-2">Unlock the secrets of your life with Swrahan’s expert numerology
                                    guidance!
                ...
                <div id="vastu" class="content-section">
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="image-wrapper h-100">
                                <div class="animation-wrapper" id="globeanimate">
                                    <img src="{{ asset('frontend/assests/images/hero-section/vastu-hands.png') }}"
                                        alt="" class="img-fluid web-2">
                                </div>
                        ...
                        <div class="col-lg-7">
                            <div class="brown-cards-content mt-5 mb-lg-5 mb-3">
                                <p class="mb-2">Transform your living and working spaces with Swrahan’s expert Vastu
                                    Shastra
                ...
                <div id="manifestation" class="content-section">
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="image-wrapper h-100">
                                <div class="animation-wrapper" id="globeanimate">
                                    <img src="{{ asset('frontend/assests/images/hero-section/manifest-hands.png') }}"
                                        alt="" class="img-fluid web-2">
                                </div>
                ...
                <div id="signature" class="content-section">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="brown-cards-content mt-5 mb-lg-5 mb-3">
                                <p class="mb-2">Unlock the secrets of your success with Swrahan’s Signature Analysis!
                                    Your
                ...
                <div id="watch" class="content-section">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="brown-cards-content mt-5 mb-lg-5 mb-3">
                                <p class="mb-2">Discover the impact of your watch with Swrahan’s unique Watch Analysis!
                                    At
                        ...
                        <div class="carousel-item active">
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-8 custom-carousel-content">
                                    ...
                                    <p class="mb-3 carousel-content-descriprtion">Ravi Mundra is a seasoned Astrology and
                                        Numerology expert with over 15 years of experience. His expertise spans Vedic
                                        Astrology, KP Astrology, Bhrigu Nadi, and Nandi systems, along with a keen
                                        proficiency in numerology, including mobile numbers, personal names, and business
                                        names. With over 500+ lucky SIMs provided across India, Ravi’s work in enhancing
                                        fortunes is proven and impactful.
                                        In addition to this, Ravi is a scientific logo designer, crafting logos that channel
                                        energy for success. As a visiting Vastu expert, he helps harmonize spaces to foster
                                        balance and positive energy flow. His hallmark is instant predictions for
                                        situational challenges, whether business or personal, offering practical remedies
                                        using Vedic traditions, Rudraksha therapy, Ravan Samhita, and more.
                                        With his comprehensive approach and personalized solutions, Ravi Mundra is a go-to
                        ...
                        <div class="carousel-item">
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-8 custom-carousel-content">
                                    ...
                                    <p class="mb-3 carousel-content-descriprtion">Swati Mundra is a seasoned Vastu
                                        consultant with over 10 years of expertise, excelling in optimizing spaces for
                                        homes, offices, and shops. She has also mastered industrial Vastu, driving
                                        significant growth and success for businesses. In addition, Swati is a skilled
                                        numerologist, specializing in mobile numerology, name numerology, and advising
                                        parents on auspicious baby names. Her remedies have delivered results in financial
                                        growth, relationships, business expansion, marriage harmony, and career
                                        advancements.
                                        With a unique blend of Rudraksha and crystal therapies, Swati’s holistic approach
            ...
            <div class="tab-n-container">
                ...
                <div id="VastuShastra" class="tab-content-n unlock-bg" style="display: block;">
                    <div class="row gy-3">
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="d-flex align-items-center justify-content-center h-100 "><img
                                    src="{{ asset('frontend/assests/images/hero-section/vastu-bg-image.png') }}"
                                    alt="icon " class="img-fluid custom-width-image-vastu">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="vastu-description">
    ...
    <section class="combining-astrology primary-bg combining-astrology-bg ">
        <div class="container-fluid custom-padded-container custom-container-width custom-container-max-width">
            ...
            <div class="row gx-2 align-items-center">
                <div class="col-lg-6">
                    <div>
                        <img src="{{ asset('frontend/assests/images/hero-section/work-life-balance.png') }}"
                            alt="" class="img-fluid">
                    </div>
                    ...
                    <div id="recipeCarousel" class="carousel proin-wrap slide" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            @foreach ($article as $item)
                                <div class="carousel-item proin {{ $loop->first ? 'active' : '' }}"
