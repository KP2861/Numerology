...
<div style="height: 900px; width:70%; margin:0 auto;">
    <table style="width: 100%">
        ...
        <tbody>
            @foreach ($result['full_name_details'] as $detail)
                <tr>
                    <td style="padding: 30px 0 0 0">
                        <table style="width: 100%;">
                            <thead>
                                <tr>
                                    <th colspan="2" style="padding: 5px; color:#8B6C56; font-size:60px;">
                                        {{ $detail['letter'] }}
                                    </th>
                                </tr>
                            </thead>
                                    ...
                                    <td style="padding-top:20px;">
                                        <table style="width: 100%; border-collapse: collapse;">
                                            <tbody>
                                                <tr>
                                                    <td
                                                        style="width:50%; padding:10px; border-right:1px solid #C8C8C8; border-bottom:1px solid #C8C8C8; vertical-align:top">
                                                        <table style="width: 100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <h5 style="font-size:16px">Strengths</h5>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="">
                                                    ...
                                                    <td
                                                        style="width:50%; padding:10px; border-bottom:1px solid #C8C8C8; vertical-align:top">
                                                        <table style="width: 100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <h5 style="font-size:16px">Weaknesses</h5>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="">
                                                ...
                                                <tr>
                                                    <td
                                                        style="width:50%; padding:10px; border-right:1px solid #C8C8C8; border-top:1px solid #C8C8C8; vertical-align:top">
                                                        <table style="width: 100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <h5 style="font-size:16px">Best Jobs</h5>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="">
                                                    ...
                                                    <td
                                                        style="width:50%; padding:10px; border-top:1px solid #C8C8C8; vertical-align:top">
                                                        <table style="width: 100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <h5 style="font-size:16px">Nature</h5>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="">
