                                    ...
                                    <tr>
                                        <td style="padding-top:20px;">
                                            <table style="width: 100%; border-collapse: collapse;">
                                                <tbody>
                                                    <tr>
                                                        <td style="width:50%; padding:10px; border-right:1px solid #C8C8C8; border-bottom:1px solid #C8C8C8; vertical-align:top">
                                                            <table style="width: 100%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                        ...
                                                        <td style="width:50%; padding:10px; border-bottom:1px solid #C8C8C8; vertical-align:top">
                                                            <table style="width: 100%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td style="width:50%; padding:10px; border-right:1px solid #C8C8C8; border-top:1px solid #C8C8C8; vertical-align:top">
                                                            <table style="width: 100%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                        ...
                                                        <td style="width:50%; padding:10px; border-top:1px solid #C8C8C8; vertical-align:top">
                                                            <table style="width: 100%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
