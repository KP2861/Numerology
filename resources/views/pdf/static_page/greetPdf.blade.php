        ...
        <tbody>
            <tr>
                <td style="padding: 0px 0; text-align:center; width:100%">
                    <img src="{{ $imageSrc }}" alt="ganpati" style="margin:20px 0px; width:200px">
                </td>
            </tr>
            <tr>
                ...
                <td style="padding-top:20px; text-align:center;">
                    <div style="text-align: center;">
                        <h5 style="color:#000; font-size:16px; font-weight:600;  ">
                            Hi user-name, <span style="font-weight: bold">Swati Mundrra</span> is here for your life
                            prediction.
                        </h5>
                    </div>
                </td>
                ...
                <td>
                    <div>
                        <img src="{{ $imageQR }}" alt="qr"
                            style="max-width:100%; height:100px; margin-top:30px;">
                    </div>
                </td>
            </tr>
        </tbody>
