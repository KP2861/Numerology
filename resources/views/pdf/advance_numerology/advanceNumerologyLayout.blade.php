...
<body>
 ...
 --}}
    ...
    <div class="content"> 
        @include('pdf.advance_numerology.areaOfStruggle') </div>
    <div class="page-break"></div>
    ...
    <div class="content"> 
        @include('pdf.dyanamic_page.mobileNumerologySecond') </div>
    <div class="page-break"></div>

    <div class="content"> 
        @include('pdf.dyanamic_page.mobileNumerologyThird') </div>
    <div class="page-break"></div>
