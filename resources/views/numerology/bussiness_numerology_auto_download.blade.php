            ...
            <div class="text-center order-successful-section-outer">
                ...
                <div class="container text-center  mt-3">
                    ...
                    <p class="mt-3 client-order-details text-black">The report will start downloading shortly. You will
                        ...
                        seconds...</p>
                    <form id="downloadForm" action="{{ route('download_bussiness') }}" method="POST" class="d-none"
                        >
                        @csrf
                    </form>
                ...
                <div class="client-order-details mt-md-0 mt-1 md-5 pt-md-4">
                    ...
                    <p class="mb-1"><span>Client Email :
                        </span>{{ session('numerology_payment.business_numerology_data.email', 'N/A') }}</p>


                    <p class="mb-1"><span>Client Phone
                            :</span>{{ session('numerology_payment.business_numerology_data.phone_number', 'N/A') }}</p>
                </div>
