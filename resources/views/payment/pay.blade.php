...
<body class="d-flex justify-content-center align-items-center vh-100 bg-light">
    <div class="card payment-card shadow-sm">
        ...
        <div class="payment-body">
            ...
            <p class="card-text mt-3">You are about to pay <span
                    class="highlight">₹{{ number_format($order->amount / 100, 2) }}</span> for <span
                    class="highlight">{{ $paymentPurpose }}</span>.</p>
