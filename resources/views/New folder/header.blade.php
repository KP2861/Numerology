            ...
            <div class="col-12">
                <nav class="hs_main_menu_n hidden-xs d-flex justify-content-between flex-row align-items-center">
                    ...
                    <div class="d-flex align-items-baseline h-100">
                        ...
                        <div class="d-flex align-items-center justify-content-center ms-3"> <button  class="outline-button">Get your Report Now</button></div>
                            ...
                            <div class="col-xs-6 col-sm-6">
                                <div class="hs_logo">
                                    <a href="index.html"><img
                                            src="{{ asset('frontend/assests/images/content/top_logo.png') }}" alt="Logo"
                                            title="Logo"></a>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6">
