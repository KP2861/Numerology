...
class BusinessNumerologyController extends Controller
{
    ...
    private function getDasha($dob)
    {
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            $dashaData = Dasha::where('id', $number)->first();
            // dd($dashaData );
...
";
        ...
        $directoryPath = storage_path('app/public/uploads/bussinessNumerology');
    ...
    private function calculateMobileNumberNumerology($mobileNumber)
    {
        ...
        $detail = $mobileNumberDetail ? $mobileNumberDetail->impact : 'No details found for this mobile number total.';
        list($maxCount, $maxDigit) = $this->getLargestRecurringDigit($mobileNumber);
