    ...
    public function run(): void
    {
        ...
        $data = [ 
            [
                'digit' => '0',
                'type' => 'Malefic',
                'behaviour' => 'Arash se farsh tak (Ups and Downs: Life with this digit can be like a rollercoaster, with major highs and lows.
        ...
        Turbulent Times: This digit brings a lot of change and uncertainty.'
            ...
            [
                'digit' => '1',
                'type' => 'Neutral',
                'behaviour' => 'Confident Leader: You’re likely to shine with strong self-esteem and leadership skills.
        ...
        Balancing Act: Finding the right balance between confidence and humility can be a challenge.'
            ...
            [
                'digit' => '2',
                'type' => 'Malefic',
                'behaviour' => 'Emotional Waves: This digit can lead to mood swings and emotional ups and downs.
        ...
        Health Impact: Managing stress is key to staying healthy.'
            ...
            [
                'digit' => '3',
                'type' => 'Neutral',
                'behaviour' => 'Curious Learner: You’re naturally curious and eager to explore new things.
        ...
        Vulnerable to Exploitation: Be mindful of your trusting nature to avoid being taken advantage of.'
            ...
            [
                'digit' => '4',
                'type' => 'Malefic',
                'behaviour' => 'Digestive Issues: This digit can bring challenges like gastric problems.
        ...
        Persistent Hurdles: Be prepared for frequent changes and delays.'
            ...
            [
                'digit' => '5',
                'type' => 'Benific',
                'behaviour' => 'Business Boost: This digit is great for business success and financial growth.
        ...
        Resourceful Approach: Your cleverness helps you achieve success and growth.'
            ...
            [
                'digit' => '6',
                'type' => 'Benific',
                'behaviour' => 'Luxurious Life: You enjoy the finer things, like luxury and travel.
        ...
        Critical Perspective: Enjoys comfort but may focus on what could be better.'
            ...
            [
                'digit' => '7',
                'type' => 'Malefic',
                'behaviour' => 'Relationship Struggles: You may face challenges in personal relationships.
        ...
        Introspective Nature: Prefers deep thinking and personal reflection.'
            ...
            [
                'digit' => '8',
                'type' => 'Neutral',
                'behaviour' => 'Family First: You carry significant responsibilities within your family.
        ...
        Duty Bound: Your sense of duty drives you to care for and support your family.'
            ...
            [
                'digit' => '9',
                'type' => 'Neutral',
                'behaviour' => 'Strong and Resilient: You have the strength to handle tough situations.
